...
#ifndef __nad_lcm_ro_vui_report_hpp__
#define __nad_lcm_ro_vui_report_hpp__
...
int ro_vui_report::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int ro_vui_report::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int ro_vui_report::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t ro_vui_report::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* ro_vui_report::getTypeName()
{
    return "ro_vui_report";
}

int ro_vui_report::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int ro_vui_report::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int ro_vui_report::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t ro_vui_report::_computeHash(const __lcm_hash_ptr *p)
{
    const __lcm_hash_ptr *fp;
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == ro_vui_report::getHash)
            return 0;
    const __lcm_hash_ptr cp = { p, (void*)ro_vui_report::getHash };
