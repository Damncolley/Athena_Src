...
#ifndef __nad_lcm_cu_set_platoon_respond_hpp__
#define __nad_lcm_cu_set_platoon_respond_hpp__
...
class cu_set_platoon_respond
{
    ...
    public:
        ...
        /**
         * Returns "cu_set_platoon_respond"
         */
...
int cu_set_platoon_respond::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int cu_set_platoon_respond::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int cu_set_platoon_respond::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t cu_set_platoon_respond::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* cu_set_platoon_respond::getTypeName()
{
    return "cu_set_platoon_respond";
}

int cu_set_platoon_respond::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int cu_set_platoon_respond::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int cu_set_platoon_respond::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t cu_set_platoon_respond::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xb1fa468a0f995c95LL;
