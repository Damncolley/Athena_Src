...
#ifndef __nad_lcm_rc_alarm_report_hpp__
#define __nad_lcm_rc_alarm_report_hpp__
...
/// rsu->csu：上报告警（供CSU转发给OCT）
class rc_alarm_report
{
    public:
...
int rc_alarm_report::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int rc_alarm_report::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int rc_alarm_report::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t rc_alarm_report::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* rc_alarm_report::getTypeName()
{
    return "rc_alarm_report";
}

int rc_alarm_report::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int rc_alarm_report::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int rc_alarm_report::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t rc_alarm_report::_computeHash(const __lcm_hash_ptr *)
{
