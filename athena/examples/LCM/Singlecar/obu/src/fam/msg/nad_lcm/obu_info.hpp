...
class obu_info
{
    public:
        ...
        nad_lcm::center_point cur_point;
        ...
        int32_t    sensor_stat[16];

        int32_t    cur_gears;

        int32_t    is_auto_drive;
...
int obu_info::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->cur_brake, 1);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    tlen = __int32_t_encode_array(buf, offset + pos, maxlen - pos, &this->sensor_stat[0], 16);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int32_t_encode_array(buf, offset + pos, maxlen - pos, &this->cur_gears, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int32_t_encode_array(buf, offset + pos, maxlen - pos, &this->is_auto_drive, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int32_t_encode_array(buf, offset + pos, maxlen - pos, &this->is_online, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int32_t_encode_array(buf, offset + pos, maxlen - pos, &this->platoon_sn, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int obu_info::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->cur_brake, 1);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, &this->sensor_stat[0], 16);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, &this->cur_gears, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, &this->is_auto_drive, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, &this->is_online, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, &this->platoon_sn, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
uint64_t obu_info::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0xcd7322b8a2493398LL +
         nad_lcm::center_point::_computeHash(&cp);
