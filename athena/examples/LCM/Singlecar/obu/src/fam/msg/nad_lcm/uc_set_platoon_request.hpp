...
#ifndef __nad_lcm_uc_set_platoon_request_hpp__
#define __nad_lcm_uc_set_platoon_request_hpp__
...
class uc_set_platoon_request
{
    ...
    public:
        ...
        /**
         * Returns "uc_set_platoon_request"
         */
...
int uc_set_platoon_request::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int uc_set_platoon_request::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int uc_set_platoon_request::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t uc_set_platoon_request::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* uc_set_platoon_request::getTypeName()
{
    return "uc_set_platoon_request";
}

int uc_set_platoon_request::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int uc_set_platoon_request::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int uc_set_platoon_request::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t uc_set_platoon_request::_computeHash(const __lcm_hash_ptr *)
{
