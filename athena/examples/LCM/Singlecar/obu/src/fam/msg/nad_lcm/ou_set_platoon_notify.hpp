...
#ifndef __nad_lcm_ou_set_platoon_notify_hpp__
#define __nad_lcm_ou_set_platoon_notify_hpp__
...
/// obu->vui：修改编队通知（仅RSU修改成功时发出）
class ou_set_platoon_notify
{
    public:
...
int ou_set_platoon_notify::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int ou_set_platoon_notify::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int ou_set_platoon_notify::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t ou_set_platoon_notify::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* ou_set_platoon_notify::getTypeName()
{
    return "ou_set_platoon_notify";
}

int ou_set_platoon_notify::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int ou_set_platoon_notify::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int ou_set_platoon_notify::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t ou_set_platoon_notify::_computeHash(const __lcm_hash_ptr *)
{
