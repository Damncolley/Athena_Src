...
#ifndef __nad_lcm_platoon_info_hpp__
#define __nad_lcm_platoon_info_hpp__
...
int platoon_info::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int platoon_info::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int platoon_info::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t platoon_info::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* platoon_info::getTypeName()
{
    return "platoon_info";
}

int platoon_info::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->dis_to_front, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int platoon_info::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->dis_to_front, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int platoon_info::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t platoon_info::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xc13eb296c5bb5d9cLL;
