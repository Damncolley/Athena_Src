...
#ifndef __nad_lcm_rc_upcall_request_hpp__
#define __nad_lcm_rc_upcall_request_hpp__
...
int rc_upcall_request::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int rc_upcall_request::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int rc_upcall_request::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t rc_upcall_request::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* rc_upcall_request::getTypeName()
{
    return "rc_upcall_request";
}

int rc_upcall_request::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int rc_upcall_request::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int rc_upcall_request::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t rc_upcall_request::_computeHash(const __lcm_hash_ptr *p)
{
    const __lcm_hash_ptr *fp;
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == rc_upcall_request::getHash)
            return 0;
    const __lcm_hash_ptr cp = { p, (void*)rc_upcall_request::getHash };
