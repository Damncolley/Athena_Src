...
#ifndef __nad_lcm_mo_degrade_request_hpp__
#define __nad_lcm_mo_degrade_request_hpp__
...
int mo_degrade_request::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int mo_degrade_request::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int mo_degrade_request::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t mo_degrade_request::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* mo_degrade_request::getTypeName()
{
    return "mo_degrade_request";
}

int mo_degrade_request::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int mo_degrade_request::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int mo_degrade_request::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t mo_degrade_request::_computeHash(const __lcm_hash_ptr *)
{
