...
#ifndef __nad_lcm_cr_add_platoon_request_hpp__
#define __nad_lcm_cr_add_platoon_request_hpp__
...
class cr_add_platoon_request
{
    ...
    public:
        ...
        /**
         * Returns "cr_add_platoon_request"
         */
...
int cr_add_platoon_request::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int cr_add_platoon_request::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int cr_add_platoon_request::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t cr_add_platoon_request::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* cr_add_platoon_request::getTypeName()
{
    return "cr_add_platoon_request";
}

int cr_add_platoon_request::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int cr_add_platoon_request::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int cr_add_platoon_request::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t cr_add_platoon_request::_computeHash(const __lcm_hash_ptr *p)
{
    const __lcm_hash_ptr *fp;
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == cr_add_platoon_request::getHash)
            return 0;
    const __lcm_hash_ptr cp = { p, (void*)cr_add_platoon_request::getHash };
